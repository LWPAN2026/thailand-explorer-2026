const CACHE='thailand-explorer-v3';const ASSETS=["./", "./index.html", "./manifest.webmanifest", "./assets/icon.svg", "./assets/hero.svg", "./assets/ayutthaya.svg", "./assets/rayong.svg", "./assets/bangkok.svg", "./assets/food.svg", "./assets/shopping.svg", "./assets/tools.svg"];
